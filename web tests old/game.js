...
var ASM_CONSTS = {
  107540: () => { if (document.fullscreenElement) return 1; },  
 107586: () => { return document.getElementById('canvas').width; },  
 107638: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107706: () => { document.exitFullscreen(); },  
 107733: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107806: () => { if (document.fullscreenElement) return 1; },  
 107852: () => { return document.getElementById('canvas').width; },  
 107904: () => { return screen.width; },  
 107929: () => { document.exitFullscreen(); },  
 107956: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 108089: () => { return window.innerWidth; },  
 108115: () => { return window.innerHeight; },  
 ...
 108308: () => { if (document.fullscreenElement) return 1; },  
 108354: () => { return document.getElementById('canvas').width; },  
 108406: () => { return screen.width; },  
 108431: () => { return window.innerWidth; },  
 108457: () => { return window.innerHeight; },  
 108484: () => { if (document.fullscreenElement) return 1; },  
 108530: () => { return document.getElementById('canvas').width; },  
 108582: () => { return screen.width; },  
 108607: () => { document.exitFullscreen(); },  
 108634: () => { if (document.fullscreenElement) return 1; },  
 108680: () => { return document.getElementById('canvas').width; },  
 108732: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108800: () => { document.exitFullscreen(); },  
 108827: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 108885: () => { return screen.width; },  
 108910: () => { return screen.height; },  
 108936: () => { return window.screenX; },  
 108963: () => { return window.screenY; },  
 108990: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 109043: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 109114: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 109171: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 109427: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 109498: () => { if (document.fullscreenElement) return 1; },  
 109544: () => { return window.innerWidth; },  
 109570: () => { return window.innerHeight; },  
 109597: () => { if (document.pointerLockElement) return 1; }
};
