...
var ASM_CONSTS = {
  107556: () => { if (document.fullscreenElement) return 1; },  
 107602: () => { return document.getElementById('canvas').width; },  
 107654: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107722: () => { document.exitFullscreen(); },  
 107749: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107822: () => { if (document.fullscreenElement) return 1; },  
 107868: () => { return document.getElementById('canvas').width; },  
 107920: () => { return screen.width; },  
 107945: () => { document.exitFullscreen(); },  
 107972: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 108105: () => { return window.innerWidth; },  
 108131: () => { return window.innerHeight; },  
 108158: () => { if (document.fullscreenElement) return 1; },  
 108204: () => { return document.getElementById('canvas').width; },  
 108256: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108324: () => { if (document.fullscreenElement) return 1; },  
 108370: () => { return document.getElementById('canvas').width; },  
 108422: () => { return screen.width; },  
 108447: () => { return window.innerWidth; },  
 108473: () => { return window.innerHeight; },  
 108500: () => { if (document.fullscreenElement) return 1; },  
 108546: () => { return document.getElementById('canvas').width; },  
 108598: () => { return screen.width; },  
 108623: () => { document.exitFullscreen(); },  
 108650: () => { if (document.fullscreenElement) return 1; },  
 108696: () => { return document.getElementById('canvas').width; },  
 108748: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108816: () => { document.exitFullscreen(); },  
 108843: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 108901: () => { return screen.width; },  
 108926: () => { return screen.height; },  
 108952: () => { return window.screenX; },  
 108979: () => { return window.screenY; },  
 109006: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 109059: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 109130: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 109187: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 109443: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 109514: () => { if (document.fullscreenElement) return 1; },  
 109560: () => { return window.innerWidth; },  
 109586: () => { return window.innerHeight; },  
 109613: () => { if (document.pointerLockElement) return 1; }
};
