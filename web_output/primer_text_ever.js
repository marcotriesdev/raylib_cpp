...
var ASM_CONSTS = {
  107684: () => { if (document.fullscreenElement) return 1; },  
 107730: () => { return document.getElementById('canvas').width; },  
 107782: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107850: () => { document.exitFullscreen(); },  
 107877: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107950: () => { if (document.fullscreenElement) return 1; },  
 107996: () => { return document.getElementById('canvas').width; },  
 108048: () => { return screen.width; },  
 108073: () => { document.exitFullscreen(); },  
 108100: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 108233: () => { return window.innerWidth; },  
 108259: () => { return window.innerHeight; },  
 ...
 108452: () => { if (document.fullscreenElement) return 1; },  
 108498: () => { return document.getElementById('canvas').width; },  
 108550: () => { return screen.width; },  
 108575: () => { return window.innerWidth; },  
 108601: () => { return window.innerHeight; },  
 108628: () => { if (document.fullscreenElement) return 1; },  
 108674: () => { return document.getElementById('canvas').width; },  
 108726: () => { return screen.width; },  
 108751: () => { document.exitFullscreen(); },  
 108778: () => { if (document.fullscreenElement) return 1; },  
 108824: () => { return document.getElementById('canvas').width; },  
 108876: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108944: () => { document.exitFullscreen(); },  
 108971: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 109029: () => { return screen.width; },  
 109054: () => { return screen.height; },  
 109080: () => { return window.screenX; },  
 109107: () => { return window.screenY; },  
 109134: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 109187: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 109258: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 109315: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 109571: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 109642: () => { if (document.fullscreenElement) return 1; },  
 109688: () => { return window.innerWidth; },  
 109714: () => { return window.innerHeight; },  
 109741: () => { if (document.pointerLockElement) return 1; }
};
